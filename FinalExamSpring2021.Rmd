...
summary(beta2)
```
There are three significant variables that predicts the percentage of up-to-date vaccines. The variables with the best predictive power is the percentage of family poverty, then the enrolled students, and the number of schools. Increasing in the percentage of family poverty and the number of enrolled students will increase the percentage of up-to-date vaccine, while increasing in total number of school will result in decrease of the percentage of up-to-date vaccine.
